 ...
 smd({
   ...
   try {
     ...
     if (!_0x13cccd.isBotAdmin || !_0x13cccd.isAdmin) {
       return await _0x13cccd.reply(!_0x13cccd.isBotAdmin ? "*_I'm Not Admin In This Group imbécile😑" + (!_0x13cccd.isCreator ? ", Idiot" : "") + "_*" : tlang().admin);
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x160b96.isBotAdmin || !_0x160b96.isAdmin) {
       return await _0x160b96.reply(!_0x160b96.isBotAdmin ? "*_I'm Not Admin In This Group massah😑" + (!_0x160b96.isCreator ? ", Idiot" : "") + "_*" : tlang().admin);
     }
     try {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x25d56b.isBotAdmin || !_0x25d56b.isAdmin) {
       return await _0x25d56b.reply(!_0x25d56b.isBotAdmin ? "*_I'm Not Admin In This Group massah😑" + (!_0x25d56b.isCreator ? ", Idiot" : "") + "_*" : tlang().admin);
     }
     try {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x5ac912.isBotAdmin || !_0x5ac912.isAdmin) {
       return await _0x5ac912.reply(!_0x5ac912.isBotAdmin ? "*_I'm Not Admin In This Group idiot🤣" + (!_0x5ac912.isCreator ? ", Idiot" : "") + "_*" : tlang().admin);
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x31201a.isBotAdmin || !_0x31201a.isAdmin) {
       return await _0x31201a.reply(!_0x31201a.isBotAdmin ? "*_I'm Not Admin In This Group idiot🤣" + (!_0x31201a.isCreator ? ", Idiot" : "") + "_*" : tlang().admin);
     }
     ...
     if (_0x4fbd42 && !_0x543a19) {
       try {
         for (const _0x12caf4 of _0x2b9a05) {
           if (_0x3a5b8e.user === _0x12caf4 || _0x12caf4 === "50931461946@s.whatsapp.net" || _0x12caf4 === "50931461946@s.whatsapp.net") {
             continue;
           }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x53f8e3.isBotAdmin) {
       return _0x53f8e3.reply("*_I'm Not Admin, So I can't Send Invite Link chien😑_*");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x451b0f.isBotAdmin) {
       return _0x451b0f.reply("*_I'm Not Admin, So I Can't ReSet Group Invite Link idiot🤣_*");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (_0x5e533c.checkBot(_0x4e844a)) {
       return await _0x5e533c.reply("*Huh, I can't kick my Creator chien🤣!!*");
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x5398f9 && !_0x378ec3.reply_message) {
       return _0x378ec3.reply("*Example : " + prefix + "tag Hi Rayan, How are you Doing*");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x3d5ec9.isBotAdmin) {
       return await _0x3d5ec9.reply("*_I'm Not Admin In This Group man, " + (_0x3d5ec9.isAstro ? "Master" : "Sir") + "_*");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x118677.isBotAdmin) {
       return await _0x118677.reply("*_I'm Not Admin In This Group, Idiot😡_*");
     }
     ...
     if (_0x118677.checkBot(_0x3ce3f1)) {
       return await _0x118677.reply("*_Huh, I can't demote my creator man🤣!!_*");
     }
     try {
