...
smd({
  ...
  try {
    ...
    if (!_0x587b99) {
      return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://github.com/Bot-hostin/DRK-RAGNA-1.0*");
    }
...
let tmpUrl = "https://i.imgur.com/yBSoUuw.jpeg";
const secmailData = {};
smd({
  pattern: "tempmail",
