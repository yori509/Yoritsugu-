...
smd({
   ...
   smd({
     ...
     try {
       if (!_0x3c787b) {
         return _0x435d39.reply("*_Example : " + (prefix + _0x4839f1) + " you_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x44fbfa) {
         return _0x273636.reply("*_Example : " + (prefix + _0xf45ca4) + " STEN*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x152a11) {
         return _0xf01fbd.reply("*_Example : " + (prefix + _0x3bd3be) + " RAGNA_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x1b1b16) {
         return _0x260877.reply("*_Example : " + (prefix + _0x3fd4bb) + " DARK_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x49d874) {
         return _0x4d2f55.reply("*_Example : " + (prefix + _0x4f01f0) + " DARK_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x474228) {
         return _0x356d68.reply("*_Example : " + (prefix + _0x31efdc) + " DARK_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x1526fa) {
         return _0x5840f6.reply("*_Example : " + (prefix + _0x12cadb) + " DARK_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x537b5d) {
         return _0x2b9514.reply("*_Example : " + (prefix + _0x5b77bc) + " SANDRO_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x195908) {
         return _0x4a4e04.reply("*_Example : " + (prefix + _0x53545f) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0xde1750) {
         return _0x20b5a4.reply("*_Example : " + (prefix + _0x3f5e61) + " Sandro_*");
       }
