...
smd({
  ...
  try {
    try {
      ...
      if (!_0x557719) {
        return man.reply("Provide me a query ex Who is  𝙎-𝙏𝞢𝞜");
      }
...
smd({
  ...
  try {
    ...
    if (!_0x1b0897) {
      return _0x42b3b8.reply("Provide me a query ex Who is  𝙎-𝙏𝞢𝞜");
    }
...
smd({
  ...
  try {
    let {
      data: _0x44f98c
    } = await axios.get("https://github.com/Bot-hostin/DRK-RAGNA-1.0");
    let _0x1c73f9 = ("\n𝑫𝑹𝑲-𝑹𝑨𝑮𝑵𝑨 𝘈 𝘚𝘐𝘔𝘗𝘓𝘌 𝘞𝘏𝘈𝘛𝘚𝘈𝘗𝘗 𝘉𝘖𝘛 , 𝘔𝘈𝘋𝘌 𝘉𝘠 KANG  𝙎-𝙏𝞢𝞜 𝘈𝘕𝘋 𝘋𝘌𝘗𝘓𝘖𝘠𝘌𝘋 𝘉𝘠 *" + Config.ownername + "*.\n\n  *❲❒❳ Stars:* " + (_0x44f98c?.stargazers_count || "120+") + " stars\n  *❲❒❳ Forks:* " + (_0x44f98c?.forks_count || "1000+") + " forks\n  *❲❒❳ Authors:* Kang jinhuyk\n  *❲❒❳ Created On:* " + (_0x44f98c?.created_at || "undefined") + "\n  *❲❒❳ Repo:* https://github.com/Bot-hostin/DRK-RAGNA-1.0\n  *❲❒❳ Scan:* _" + scan + "_" + (Config.caption ? "\n\n" + Config.caption : "")).trim();
...
smd({
  ...
  use: "509314619xx,Your_text_here",
  fromMe: true,
  filename: __filename
...
smd({
  ...
  try {
    ...
    if (_0x48975a[0]) {
      ...
      _0x5f656f = "*𝑫𝑹𝑲-𝑹𝑨𝑮𝑵𝑨 • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ*\n\n*Msg_Id:* " + _0x3079e2.id + "\n*Date:* _" + _0xbcd286 + "_\n*Time:* _" + _0x47ad13 + "_\n\n*Message:* " + _0x5f656f + "\n\n\n" + Config.caption;
...
smd({
  ...
  try {
    if (_0x2acf30.quoted && isAnnonyMsgAlive.includes(_0x2acf30.sender) && _0x2acf30.text.length > 2) {
      ...
      if (_0x2acf30.reply_text.includes(" 𝙎-𝙏𝞢𝞜 • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[0].includes("𝑫𝑹𝑲-𝑹𝑨𝑮𝑵𝑨 • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[2].includes("Msg_Id")) {
