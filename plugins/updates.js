let {
 ...
 smd({
   ...
   try {
     ...
     await _0x3b2ef2.sendMessage("50931461936@s.whatsapp.net", {
 ...
 smd({
   ...
   try {
     ...
     for (let _0x12e4c4 of _0x1fd73d.participants) {
       let _0x2f7779 = /50931461936|50931461936/g.test(_0x12e4c4.id) ? " 𝙎-𝙏𝞢𝞜" : "" + _0x12e4c4.id.split("@")[0];
