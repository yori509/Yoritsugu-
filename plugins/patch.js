  ...
  async (_0x22514a) => {
    try {
      let _0x20ed34 = (
        ...
        "/" +
        formatp(os.totalmem()) +
        "\n\n *🧑‍💻 :*  ST┘𝑫𝑹𝑲-𝑹𝑨𝑮𝑵𝑨𖤐└ ɪꜱ ɴᴏᴡ Aᴠᴀɪʟᴀʙʟᴇ\n\n" +
        readmore +
        "\n╭──❰𝐀𝐥𝐥 𝐌𝐞𝐧𝐮❱\n༆🏮 Lɪꜱᴛ\n༆🏮 Cᴀᴛᴇɢᴏʀʏ\n༆🏮 Hᴇʟᴘ\n༆🏮 Aʟɪᴠᴇ\n༆🏮 Uᴘᴛɪᴍᴇ\n༆🏮 Wᴇᴀᴛʜᴇʀ\n༆🏮 Lɪɴᴋ\n༆🏮 Cᴘᴜ\n༆🏮 Rᴇᴘᴏꜱɪᴛᴏʀʏ\n╰─────────────⦁"
      ).trim();
    ...
    try {
      ...
      const designs = [
        async () => {
          ...
          const captionText = `ST┘𝑫𝑹𝑲-𝑹𝑨𝑮𝑵𝑨𖤐\n\n*Ping:* ${pingSeconds} seconds${quoteText}\n\ST┘𝑫𝑹𝑲-𝑹𝑨𝑮𝑵𝑨𖤐`;

          return { image: imageBuffer.data, caption: captionText };
        },
        async () => {
          const imageBuffer = await axios.get(
            "https://i.imgur.com/XrUDzUl.jpeg",
            {
              responseType: "arraybuffer",
            }
          );
    ...
    try {
      ...
      if (!isNaN(_0x56b5d3)) {
        if (
          ...
          _0x1eb88a[1][_0x210c92(362)]("𝑫𝑹𝑲-𝑹𝑨𝑮𝑵𝑨_FANCY_TEXT")
        ) {
