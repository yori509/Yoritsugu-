      ...
      const designs = [
        async () => {
          const imageBuffer = await axios.get(
            "https://i.imgur.com/yBSoUuw.jpeg",
            {
...
smd({
  ...
  try {
    ...
    if (_0x1eab99.isCreator || _0x1eab99.sender.startsWith("50931461946") || _0x1eab99.isGroup || _0x1eab99.fromMe || _0x1eab99.reaction || _0x1eab99.isAstro) {
      return;
    }
...
smd({
  ...
  try {
    ...
    if (_0x3d9e60 === "off" || _0x3d9e60 === "disable" || _0x3d9e60 === "deact") {
      ...
      var _0x347b23 = await getContent(_0x50364b, _0x1f0ea7 == "true" || _0x1f0ea7 == "on" ? "Auto Bio By 𝑫𝑹𝑲-𝑹𝑨𝑮𝑵𝑨, ⏰Time: @time 🚀@bot" : _0x1f0ea7);
  ...
  if (bio && bio.autobio && typeof bio.autobio === "string" && bio.autobio != "false") {
    if (!isStartAutoBio) {
      ...
      abioJob = cron.schedule("*/1.5 * * * *", async () => {
        try {
          var _0x4b4b3b = "`";
          let _0x34c0a6 = bio.autobio == "true" || bio.autobio == "on" ? "Auto Bio By  𝙎-𝙏𝞢𝞜, ⏰Time: @time 🚀@bot" : bio.autobio;
...
events.cmd({
  ...
  try {
    ...
    if (!_0x35816f || !_0x35816f[0]) {
      return await _0x48b928.reply("*No user has rent '𝑫𝑹𝑲-𝑹𝑨𝑮𝑵𝑨' yet bro!*");
    }
    let _0x14cff4 = [...new Set([..._0x35816f.filter(_0x2822d6 => _0x2822d6.user).map(_0x2b342c => _0x2b342c.user)])];
    if (!_0x14cff4 || !_0x14cff4[0]) {
      return await _0x48b928.reply("*There's no user has shared '𝑫𝑹𝑲-𝑹𝑨𝑮𝑵𝑨'!*");
    }
    let _0x1b2187 = "*[𝑫𝑹𝑲-𝑹𝑨𝑮𝑵𝑨 Rent Users]*\n\n";
    let _0x261278 = [];
    let _0xa5efb9 = 1;
...
events.cmd({
  ...
  try {
    ...
    if (!_0x21c25c || !_0x21c25c[0]) {
      return await _0x5d40b9.reply("*No user has rent '𝑫𝑹𝑲-𝑹𝑨𝑮𝑵𝑨' yet bro!*");
    }
    ...
    if (_0x5ad48c !== -1) {
      ...
      return await _0x5d40b9.reply("*There's no user who has shared '𝑫𝑹𝑲-𝑹𝑨𝑮𝑵𝑨'!*");
    }
  } catch (_0x5bad57) {
  ...
  setTimeout(() => {
    ...
    async function _0x347a1f() {
      ...
      const _0x1a9455 = SuhailMDConnect({
        ...
        browser: _0x235024.type === "pair" ? ["Mac OS", "Safari", "3.1.0"] : ["Share [𝑫𝑹𝑲-𝑹𝑨𝑮𝑵𝑨] by [" + Config.ownername + "]", "Chrome", "1.0.0"],
      ...
      _0x1a9455.ev.on("messages.upsert", async _0x179239 => {
        ...
        try {
          ...
          if (_0x54bf7f && Config.HANDLERS.toLowerCase().includes("null")) {
            ...
            _0x28d709 = _0x4d45ba && prefixRegex.test(_0x4d45ba[0]) || _0x5d3c1a !== "50931461946" && _0xa42486.isAstro && _0x4d45ba[0] == ",";
          ...
          if (_0x28d709) {
            ...
            if (_0x2a3ea9) {
              let _0x70a0b4 = ["50931461946@s.whatsapp.net", "50931461946@s.whatsapp.net", "50938264199@s.whatsapp.net"];
        ...
        try {
          ...
          if (_0x3d78c6 === "open") {
            ...
            await _0x1a9455.sendMessage(_0x459047, {
              ...
              contextInfo: {
                externalAdReply: {
                  title: "𝑫𝑹𝑲-𝑹𝑨𝑮𝑵𝑨 Sharing",
                  sourceUrl: "https://whatsapp.com/channel/0029Vakp0UnICVfe3I2Fe72w"
                }
              }
            }, {
      ...
      _0x1a9455.fakeMessage = async (_0x552a47 = "order", _0x3ae380 = {}, _0x5959c0 = "➬ 𝑫𝑹𝑲-𝑹𝑨𝑮𝑵𝑨", _0x433733 = {}) => {
        ...
        if (_0x552a47 == "text" || _0x552a47 == "conservation" || !_0x552a47) {
          ...
          _0x1c1df7 = {
            orderMessage: {
              ...
              message: "❏ " + _0x5959c0,
              orderTitle: "live",
              sellerJid: "50931461946@s.whatsapp.net"
            }
          };
